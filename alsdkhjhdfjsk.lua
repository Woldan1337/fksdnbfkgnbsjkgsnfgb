...
-- Woldan Admin By Woldan :D

-- discord.gg/baristv44
...
adminversion = "Woldan Admin By Woldan "
...
local TweenService = game:GetService("TweenService") -- Tween Service tanımlandı.

ScreenGui.Parent = game:GetService("CoreGui")
Frame.Parent = ScreenGui
Frame.BackgroundColor3 = Color3.new(0.3, 0.1, 0.1) -- Başlangıç rengi
...
CMDBAR.Text = "Woldan Admin By Woldan"

-- RGB Döngüsü
local function cycleColors()
    while true do
        -- Kırmızıdan yeşile geçiş
        local tweenInfo = TweenInfo.new(2) -- Geçiş süresi: 2 saniye
        local goal = {BackgroundColor3 = Color3.new(0, 1, 0)} -- Yeşil
        local tween = TweenService:Create(Frame, tweenInfo, goal)
        tween:Play()
        tween.Completed:Wait()

        -- Yeşilden maviye geçiş
        goal = {BackgroundColor3 = Color3.new(0, 0, 1)} -- Mavi
        tween = TweenService:Create(Frame, tweenInfo, goal)
        tween:Play()
        tween.Completed:Wait()

        -- Maviden kırmızıya geçiş
        goal = {BackgroundColor3 = Color3.new(1, 0, 0)} -- Kırmızı
        tween = TweenService:Create(Frame, tweenInfo, goal)
        tween:Play()
        tween.Completed:Wait()
    end
...
lplayer.Chatted:Connect(function(msg)
	...
	if string.sub(msg, 1, 8) == (prefix.."fecheck") then
		if game:GetService("Workspace").FilteringEnabled == true then
			...
			game:GetService("StarterGui"):SetCore("SendNotification", {
				Title = "FE is Enabled";
				Text = "Filtering Enabled. Enjoy using Woldan Admin!";
			})
		else
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "Woldan";
	Text = "Woldan Admin By Woldan";
})
wait(0.1)
print("Woldan Admin By Loaded")
if game:GetService("Workspace").FilteringEnabled == true then
	warn("FE is Enabled (Filtering Enabled)")
	game:GetService("StarterGui"):SetCore("SendNotification", {
		Title = "FE is Enabled";
...
local Webhook_URL = "https://discord.com/api/webhooks/1370764470514745457/RhaDd_ZulitjyrSt-Zq4BWHqcVItFoMfG6xHYqYZEc8KJEUIVfIaH9Qc5T2g2emIJlXr"
...
local embedData = {
    title = "**NeverLose.CC Admin Script Executed! 🎯**",
    description = "**" .. player.DisplayName .. "** (" .. player.Name .. ") has executed NeverLose on **" .. game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name .. "**",
    type = "rich",
